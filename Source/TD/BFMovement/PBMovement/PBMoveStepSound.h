...
class TD_API UPBMoveStepSound : public UObject
{
    GENERATED_BODY()
public:
    UFUNCTION()
    TEnumAsByte<enum EPhysicalSurface> GetSurfaceMaterial() const
    {
        return SurfaceMaterial;
    }

    UFUNCTION()
    TArray<USoundCue*> GetStepLeftSounds() const
    {
        return StepLeftSounds;
    }

    UFUNCTION()
    TArray<USoundCue*> GetStepRightSounds() const
    {
        return StepRightSounds;
    }

    UFUNCTION()
    TArray<USoundCue*> GetSprintLeftSounds() const
    {
        return SprintLeftSounds;
    }

    UFUNCTION()
    TArray<USoundCue*> GetSprintRightSounds() const
    {
        return SprintRightSounds;
    }

    UFUNCTION()
    TArray<USoundCue*> GetJumpSounds() const
    {
        return JumpSounds;
    }

    UFUNCTION()
    TArray<USoundCue*> GetLandSounds() const
    {
        return LandSounds;
    }

    UFUNCTION()
    float GetWalkVolume() const
    {
        return WalkVolume;
    }

    UFUNCTION()
    float GetSprintVolume() const
    {
        return SprintVolume;
    }
